  ...
  return (
    <Container className="py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {/* Users Card */}
        <div className="rounded-lg shadow-sm p-6 border" style={{ ...cardStyle, ...borderStyle }}>
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold" style={textPrimaryStyle}>-</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg shadow-sm p-6 border" style={{ ...cardStyle, ...borderStyle }}>
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-lg font-semibold text-emerald-600">{t('cards.healthy')}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-lg shadow-sm border" style={{ ...cardStyle, ...borderStyle }}>
        <div className="p-6 border-b" style={borderStyle}>
          <h2 className="text-lg font-semibold" style={textPrimaryStyle}>{t('quickActions.title')}</h2>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <a
              href="/users"
              className="flex items-center p-4 rounded-lg border transition-colors hover:opacity-80"
              style={borderStyle}
            >
